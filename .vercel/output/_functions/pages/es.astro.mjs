...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Background", $$Background, {})} ${maybeRenderHead()}<div class="relative z-10"> ${renderComponent($$result2, "Header", $$Header, { "lang": "es" })} ${renderComponent($$result2, "Hero", $$Hero, { "lang": "es" })} ${renderComponent($$result2, "Landing", $$Landing, { "lang": "es" })} ${renderComponent($$result2, "Footer", $$Footer, { "lang": "es" })} </div> ` })}`;
}, "/home/martin-jesus-crosetto/Documentos/workspace/landing-page/src/pages/es/index.astro", void 0);

const $$file = "/home/martin-jesus-crosetto/Documentos/workspace/landing-page/src/pages/es/index.astro";
const $$url = "/es";
